    ...
    <>
      ...
      <div className="relative h-[90vh] w-full overflow-hidden">
        ...
        <div className="absolute left-0 flex flex-col items-center justify-center w-full h-full text-white bottom-14">
          ...
          {/* Tombol Contact */}
          <Button variant="outline" className="px-8 py-3 text-lg font-bold transition duration-300 rounded-xl  border-[#00C6FF] border-2  hover:bg-[#00C6FF] hover:text-white">
            Our Contact
          </Button>
        </div>
      </div>
